...
class CityscapesPanopticEvaluator:
    ...
    def __init__(self, output_dir=None, train_id_to_eval_id=None, label_divisor=1000, void_label=255000,
                 gt_dir='./datasets/cityscapes', split='val', num_classes=16, panoptic_josn_file=None,
                 panoptic_json_folder=None, debug=None, target_dataset_name=None, input_image_size=None,
                 mapillary_dataloading_style='OURS', logger=None):
        """
        Args:
        ...
        if 'Cityscapes' in target_dataset_name:
            ...
            self._gt_json_file = panoptic_josn_file
            self._gt_folder = panoptic_json_folder
        else:
    ...
    def evaluate(self, logger):
        ...
        with contextlib.redirect_stdout(io.StringIO()):
            results = cityscapes_eval.evaluatePanoptic(gt_json_file, gt_folder, pred_json_file, pred_folder,
                                                       resultsFile, debug=self.debug,
