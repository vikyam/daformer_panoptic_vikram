...
command to run this script
    ...
    $ PYTHONPATH="/home/suman/apps/code/CVPR2022/cvpr2022:$PYTHONPATH" && export PYTHONPATH
...
from cityscapesscripts.helpers.labels import id2label, labels         # use this for cityscapes 19 class setup # original code
...
def convert2panoptic(cityscapesPath=None, outputFolder=None, useTrainId=False, setNames=["val", "train", "test"]):
    ...
    for label in labels:
        ...
        if label.ignoreInEval: # use this for cityscapes 19 class setup # original code
            continue
        # if label.ignoreInEval or label.trainId == 255 or label.trainId == -1: # use this for cityscapes 16 class setup
        #     continue
    ...
    # with open('/media/suman/CVLHDD/apps/datasets/cityscapes_4_panoptic_deeplab/cityscapes/gtFine/temp_val.json', 'w') as f:
    ...
    for setName in setNames:
        ...
        outputBaseFile = "cityscapes_panoptic_{}{}".format(setName, trainIfSuffix) # use this for cityscapes 19 class setup # original code
        # outputBaseFile = "cityscapes_panoptic_synthia_to_cityscapes_16cls_{}{}".format(setName, trainIfSuffix) # use this for cityscapes 16 class setup
        ...
        images = []
        annotations = []
        # img_count = 0 # this is used to generate a small subset of the val set for debug purpose only
        for progress, f in enumerate(files):
            ...
            # this is used to generate a small subset of the val set for debug purpose only
            # if img_count > 10:
            #     break
            # img_count+=1
...
def main():
    ...
    args.cityscapesPath = '/media/suman/CVLHDD/apps/datasets/Cityscapes/gtFine_trainvaltest/gtFine'
    args.outputFolder = '/media/suman/CVLHDD/apps/datasets/cityscapes_for_daformer/gtFine'
    # this below path is used to generate a small subset of the val set for debug purpose only
    # args.outputFolder = '/media/suman/DATADISK2/apps/datasets/da_former_datasets/data/cityscapes/temp'
